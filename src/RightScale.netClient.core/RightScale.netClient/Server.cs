...
namespace RightScale.netClient
{
    ...
    public class Server:Core.TaggableResourceBase<Server>
    {
        ...
        /// <summary>
        /// Creates a new azure server, and configures its corresponding "next" instance with only the required parameters.
        /// </summary>
        /// <param name="cloudID">ID of the cloud that the server should be added to</param>
        /// <param name="serverTemplateID">ID of the SErverTemplate</param>
        /// <param name="serverName">The name of the server</param>
        /// <returns>ID of the newly created server</returns>
        public static string create(string cloudID, string deploymentID, string serverTemplateID, string serverName, List<string> securityGroupIDs, string subnetHref =null, string mciHref=null, string instanceTypeID=null)
        {
            List<KeyValuePair<string, string>> parameters = createGetParameterSet(deploymentID, null, cloudID, null, null, null,instanceTypeID, null, null, null, securityGroupIDs, serverTemplateID, null, null, serverName, false,subnetHref,mciHref);
            return createPost(APIHrefs.Server, parameters);
        }
        ...
        private static List<KeyValuePair<string,string>> createGetParameterSet(
            string deploymentid, string description, string cloudID, string datacenterID, string imageID, 
            List<Input> inputs, string instanceTypeID, string kernelImageID, string multiCloudImageID, 
            string ramdiskImageID, List<string> securityGroupIDs, string serverTemplateID, string sshKeyID, 
            string userData, string name, bool optimized, string subnetHref=null, string mciHref=null
       )
        {
            ...
            Utility.addParameter(subnetHref, "server[instance][subnet_hrefs][]", retVal);
            Utility.addParameter(mciHref, "server[instance][multi_cloud_image_href]", retVal);
