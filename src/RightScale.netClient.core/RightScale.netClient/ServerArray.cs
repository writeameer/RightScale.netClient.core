...
namespace RightScale.netClient
{
    ...
    public class ServerArray : Core.TaggableResourceBase<ServerArray>
    {
        ...
        public static List<RSTask> multi_run_executable(string serverArrayID, bool ignoreLock, List<Input> inputs, string recipeName, string rightScriptID)
        {
        ...
        public static List<RSTask> multi_terminate(string serverArrayID, bool terminateAll)
        {
        ...
        /// <returns>List of Tasks to report terminate progress on</returns>
        public static List<RSTask> multi_terminate(string serverArrayID, bool terminateAll, List<Filter> filters)
        {
