...
namespace RightScale.netClient
{
    ...
    /// </summary>
    public class RSTask:Core.RightScaleObjectBase<RSTask>
    {
        ...
        public static List<RSTask> show(List<string> taskHrefs)
        {
            List<RSTask> retVal = new List<RSTask>();
        ...
        public static RSTask show(string taskHref)
        {
        ...
        /// <returns>Populated Task object</returns>
        public static RSTask show(string taskHref, string view)
        {
            if (string.IsNullOrWhiteSpace(view))
            {
                view = "default";
        ...
        /// <returns>list of Task objects</returns>
        public static List<RSTask> show(string cloudID, string instanceID, string view)
        {
