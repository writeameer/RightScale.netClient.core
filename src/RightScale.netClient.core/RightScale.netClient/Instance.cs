...
namespace RightScale.netClient
{
    ...
    public class Instance : Core.TaggableResourceBase<Instance>
    {
        ...
        public static List<RSTask> multi_run_executableServerArray(string serverArrayID, bool ignoreLock, List<Input> inputs, string recipeName, string rightScriptID)
        {
        ...
        /// <param name="rightScriptID">ID of RightScript to execute</param>
        /// <returns>List of Task objects for tracking asynchronous proces sstatus </returns>
        public static List<RSTask> multi_run_executable(string cloudID, bool ignoreLock, List<Input> inputs, string recipeName, string rightScriptID)
        {
        ...
        private static List<RSTask> multi_run_executablePost(string postHref, bool ignore_lock, List<Input> inputs, string recipeName, string rightScriptID)
        {
        ...
        public static List<RSTask> multi_terminate(string cloudID, bool terminateAll, List<Filter> filters)
        {
        ...
        /// <param name="filters">Set of filters to limit the number of instances terminated</param>
        /// <returns>true if process is queued successfully, false if not</returns>
        public static List<RSTask> multi_terminateServerArray(string serverArrayID, bool terminateAll, List<Filter> filters)
        {
        ...
        private static List<RSTask> multi_terminatePost(bool terminateAll, List<Filter> filters, string postHref)
        {
        ...
        public static RSTask run_recipe(string cloudID, string instanceID, string recipeName)
        {
        ...
        /// <returns>Task instance for tracking progress of asynchronous process</returns>
        public static RSTask run_recipe(string cloudID, string instanceID, string recipeName, Hashtable inputs)
        {
        ...
        /// <returns>Task instance for tracking progress of asynchronous process</returns>
        public static RSTask run_recipe(string cloudID, string instanceID, string recipeName, List<Input> inputs)
        {
            return run_executable(cloudID, instanceID, recipeName, null, inputs, false);
        }
        ...
        /// <returns>Task instance for tracking progress of asynchronous process</returns>
        public static RSTask run_recipe(string cloudID, string instanceID, string recipeName, Hashtable inputs, bool ignoreLock)
        {
        ...
        /// <param name="ignoreLock">Specifies the ability to ignore the lock on the Instance.</param>
        /// <returns>Task instance for tracking progress of asynchronous process</returns>
        public static RSTask run_recipe(string cloudID, string instanceID, string recipeName, List<Input> inputs, bool ignoreLock)
        {
            return run_executable(cloudID, instanceID, recipeName, null, inputs, ignoreLock);
        }
        ...
        /// <param name="rightScriptID">ID of RightScript to execute</param>
        /// <returns>Task instance for tracking progress of asynchronous process</returns>
        public static RSTask run_rightScript(string cloudID, string instanceID, string rightScriptID)
        {
        ...
        /// <param name="inputs">collection of inputs for script or recipe</param>
        /// <returns>Task instance for tracking progress of asynchronous process</returns>
        public static RSTask run_rightScript(string cloudID, string instanceID, string rightScriptID, List<Input> inputs)
        {
        ...
        /// <param name="inputs">Hashtable of inputs for script or recipe</param>
        /// <returns>Task instance for tracking progress of asynchronous process</returns>
        public static RSTask run_rightScript(string cloudID, string instanceID, string rightScriptID, Hashtable inputs)
        {
            return run_executable(cloudID, instanceID, null, rightScriptID, inputs, false);
        }
        ...
        /// <param name="ignoreLock">Specifies the ability to ignore the lock on the Instance.</param>
        /// <returns>Task instance for tracking progress of asynchronous process</returns>
        public static RSTask run_rightScript(string cloudID, string instanceID, string rightScriptID, List<Input> inputs, bool ignoreLock)
        {
        ...
        /// <param name="ignoreLock">Specifies the ability to ignore the lock on the Instance.</param>
        /// <returns>Task instance for tracking progress of asynchronous process</returns>
        public static RSTask run_rightScript(string cloudID, string instanceID, string rightScriptID, Hashtable inputs, bool ignoreLock)
        {
            return run_executable(cloudID, instanceID, null, rightScriptID, inputs, ignoreLock);
        }
        ...
        /// <param name="ignoreLock">Specifies the ability to ignore the lock on the Instance.</param>
        /// <returns>Task instance for tracking progress of asynchronous process</returns>
        public static RSTask run_executable(string cloudID, string instanceID, string recipeName, string rightScriptID, List<Input> inputs, bool ignoreLock)
        {
        ...
        /// <param name="ignoreLock">Specifies the ability to ignore the lock on the Instance.</param>
        /// <returns>Task instance for tracking progress of asynchronous process</returns>
        public static RSTask run_executable(string cloudID, string instanceID, string recipeName, string rightScriptID, Hashtable inputs, bool ignoreLock)
        {
        ...
        /// <param name="ignoreLock">Specifies the ability to ignore the lock on the Instance.</param>
        /// <returns>Task instance for tracking progress of asynchronous process</returns>
        private static RSTask run_executablePost(string cloudID, string instanceID, string recipeName, string rightScriptID, List<Input> inputs, bool ignoreLock)
        {
            ...
            return RSTask.show(taskList.Last<string>());
        }
